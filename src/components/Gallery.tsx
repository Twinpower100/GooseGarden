        ...
        {images.map((item, idx) => {
          ...
          return (
            <motion.div
              ...
              className="relative aspect-[4/3] w-[85vw] flex-shrink-0 snap-center overflow-hidden rounded-[26px] border border-[rgba(117,124,100,0.12)] bg-white shadow-[0_14px_36px_rgba(31,35,28,0.06)] md:w-[60vw] lg:w-[45vw]"
            >
              <Image
                src={item.image.url}
          ...
          {images.map((_, idx) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 ${
                idx === currentIndex
                  ? 'w-6 bg-[#596147]'
                  : 'bg-premium-400/30 hover:bg-premium-400'
              }`}
            />
          ))}
        </div>
      ...
      {enableManualNavigation && images.length > 1 && (
        <>
          <button
            ...
            className="absolute left-4 top-1/2 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-white/55 bg-white/80 opacity-0 backdrop-blur-sm transition-opacity duration-300 hover:bg-white md:flex md:group-hover:opacity-100"
          ...
          <button
            ...
            className="absolute right-4 top-1/2 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-white/55 bg-white/80 opacity-0 backdrop-blur-sm transition-opacity duration-300 hover:bg-white md:flex md:group-hover:opacity-100"
